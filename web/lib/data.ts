...
export const companies: Company[] = [
  ...
  { id: 'c14', name: 'OpenAI', slug: 'openai', tagline: 'AI Models', description: 'AI research and deployment company building safe and beneficial artificial general intelligence.', category: 'AI Models', logo: logo('openai.com'), stage: 'Series F', funding_total: 64_000_000_000, valuation: 157_000_000_000, employee_count: 2500, founded_year: 2015, hq: 'San Francisco, USA', is_unicorn: true, growth_score: 96, trending_score: 61.7, views_7d: 48200 },
  { id: 'c15', name: 'Anthropic', slug: 'anthropic', tagline: 'AI Models', description: 'AI safety company building reliable, interpretable, and steerable AI systems.', category: 'AI Models', logo: logo('anthropic.com'), stage: 'Series E', funding_total: 14_000_000_000, valuation: 61_500_000_000, employee_count: 1200, founded_year: 2021, hq: 'San Francisco, USA', is_unicorn: true, growth_score: 95, trending_score: 63.5, views_7d: 41800 },
